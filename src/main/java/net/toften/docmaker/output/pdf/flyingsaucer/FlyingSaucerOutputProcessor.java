...
public class FlyingSaucerOutputProcessor extends SingleInterimFile implements OutputProcessor {
	public void process(File outputDir, String outputName, String encoding, TOC t, LogWrapper lw) throws Exception {
		if (outputName == null)
			throw new NullPointerException("Output filename is null");
		
		File inFile = buildInterimFile(outputDir, outputName, encoding, t, lw);
